...
namespace HtmlRenderer.Core.Handlers
{
    ...
    internal static class BackgroundImageDrawHandler
    {
        ...
        public static void DrawBackgroundImage(IGraphics g, CssBox box, ImageLoadHandler imageLoadHandler, RRect rectangle)
        {
        ...
        /// </summary>
        private static void DrawRepeatX(IGraphics g, ImageLoadHandler imageLoadHandler, RRect rectangle, RRect srcRect, RRect destRect, RSize imgSize)
        {
        ...
        /// </summary>
        private static void DrawRepeatY(IGraphics g, ImageLoadHandler imageLoadHandler, RRect rectangle, RRect srcRect, RRect destRect, RSize imgSize)
        {
        ...
        /// </summary>
        private static void DrawRepeat(IGraphics g, ImageLoadHandler imageLoadHandler, RRect rectangle, RRect srcRect, RRect destRect, RSize imgSize)
        {
            while (destRect.X > rectangle.X)
                destRect.X -= imgSize.Width; 
            while (destRect.Y > rectangle.Y)
